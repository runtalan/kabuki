...
for key in DATABASE_URL AUTH_SECRET AUTH_URL AUTH_GOOGLE_ID AUTH_GOOGLE_SECRET PLAID_CLIENT_ID PLAID_SECRET PLAID_ENV PLAID_CLIENT_ID_MOMPOP PLAID_SECRET_MOMPOP PLAID_ENV_MOMPOP SUPABASE_SERVICE_ROLE_KEY APCA_API_KEY_ID APCA_API_SECRET_KEY; do
  check_secret "$key"
done
